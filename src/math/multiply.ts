...
const gpuMultiply = (a: Array2D, b: Array2D) => {
  const multiply = gpu.createKernel(function(this: any, a: any, b: any) {
...
const multiply = (
  ...
  const matrix = gpuMultiply(broadcastedLeft, broadcastedRight);
